...
public class SmartWinnrDaily {

    @NonNull
    private final SmartWinnrDailyConfig config;

    @NonNull
    private final SmartWinnrDailyPlugin plugin;
    ...
    public SmartWinnrDaily(@NonNull SmartWinnrDailyPlugin plugin, @NonNull SmartWinnrDailyConfig config) {
        this.config = config;
        this.plugin = plugin;
